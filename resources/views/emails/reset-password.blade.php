<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">
    ...
    <p style="line-height: 1.6; margin-top: 20px; color: #666; font-size: 13px;">
        <strong>Security notice:</strong> This password reset link will expire in {{ config('auth.passwords.users.expire', 60) }} minutes.
    </p>

    <hr style="margin: 30px 0; border: none; border-top: 1px solid #e5e7eb;">

    <p style="line-height: 1.6; margin-bottom: 10px; color: #666; font-size: 13px;">
        If you did not request a password reset, please ignore this message. No further action is required. Your account remains secure.
    </p>
